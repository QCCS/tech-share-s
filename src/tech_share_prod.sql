...
--
-- Host: localhost    Database: tech_share_prod
-- ------------------------------------------------------
...
--
-- Current Database: `tech_share_prod`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `tech_share_prod` /*!40100 DEFAULT CHARACTER SET utf8 */;
