...
let env = "development" || 'development';
console.log(env)
// env = "prod";
...
/* harmony import */ var koa2_file_upload__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! koa2-file-upload */ "koa2-file-upload");
/* harmony import */ var koa2_file_upload__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(koa2_file_upload__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _controller_index__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./controller/index */ "./src/controller/index.js");
/* harmony import */ var _config_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./config/index */ "./src/config/index.js");
/* harmony import */ var _middleware_error__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./middleware/error */ "./src/middleware/error.js");
/* harmony import */ var koa_views__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! koa-views */ "koa-views");
/* harmony import */ var koa_views__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(koa_views__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _route_router__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./route/router */ "./src/route/router.js");
...
app.use(koa_static__WEBPACK_IMPORTED_MODULE_3___default()(staticImgPath));
//排除某些接口,不校验
app.use(koa_jwt__WEBPACK_IMPORTED_MODULE_4___default()({secret: _config_index__WEBPACK_IMPORTED_MODULE_9__["default"].secret.sign}).unless({path: [
    /^\/api\/login/,
    /^\/img/,//静态图片
    /^\/api\/upload/,//上传文件
    /^\/doc/,//文档忽略
...
app.use(koa2_file_upload__WEBPACK_IMPORTED_MODULE_7___default()(options));
...
app.use(Object(_middleware_error__WEBPACK_IMPORTED_MODULE_10__["default"])());
...
// ejs模板引擎
// 配置扩展名 ejs
app.use(koa_views__WEBPACK_IMPORTED_MODULE_11___default()(process.cwd() + '/dist/views', {
    extension: 'ejs'
    // map: {html: 'ejs'}
}))
...
// 使用路由中间件
app.use(_controller_index__WEBPACK_IMPORTED_MODULE_8__["default"])
    .use(_route_router__WEBPACK_IMPORTED_MODULE_12__["default"].router.routes())
    .use(routerForAllow.allowedMethods());

//服务端口
app.listen(_config_index__WEBPACK_IMPORTED_MODULE_9__["default"].port);
...
/***/ "koa2-file-upload":
/*!***********************************!*\
  !*** external "koa2-file-upload" ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("koa2-file-upload");
