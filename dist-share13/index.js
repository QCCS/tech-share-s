...
/* harmony import */ var _controller_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controller/index */ "./src/controller/index.js");
/* harmony import */ var _config_config_dev_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./config/config.dev.js */ "./src/config/config.dev.js");
...
/* harmony import */ var _route_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./route/router */ "./src/route/router.js");
...
//排除某些接口,不校验
app.use(koa_jwt__WEBPACK_IMPORTED_MODULE_4___default()({secret: _config_config_dev_js__WEBPACK_IMPORTED_MODULE_6__["default"].secret.sign}).unless({path: [/^\/api\/login/,/^\/api\/register/]}));
...
// ejs模板引擎
// 配置扩展名 ejs
app.use(koa_views__WEBPACK_IMPORTED_MODULE_7___default()(process.cwd() + '/dist/views', {
    extension: 'ejs'
    // map: {html: 'ejs'}
}))
...
// 使用路由中间件
app.use(_controller_index__WEBPACK_IMPORTED_MODULE_5__["default"])
    .use(_route_router__WEBPACK_IMPORTED_MODULE_8__["default"].router.routes())
    .use(routerForAllow.allowedMethods());

//服务端口
app.listen(_config_config_dev_js__WEBPACK_IMPORTED_MODULE_6__["default"].port);
